...
were tuned empirically rather than chosen analytically: with the default
collision penalty of $-1.0$ and \code{high\_speed\_reward}$=2.0$, agents largely
ignored collisions and maintained maximum speed; raising the penalty to $-4.0$
was required before collision avoidance registered in the learned policy.
